<script lang="ts">
  ...
  const MENU_VEHICLES: {
    ...
    { id:10, brand:'Dodge',   type:'Sedán',      model:'Attitude R/T',  year:'2026', version:'SXT',              fuel:'Gasolina', price:'Desde $364,900',   img:'/adistem2026/promociones/dodge-attitude-2026.jpg', accent:'#D50000' },
