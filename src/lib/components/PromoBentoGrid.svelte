<script lang="ts">
  ...
  const ALL_VEHICLES = [
    ...
    { id:2,  brand:'Jeep',    type:'SUV',        model:'Compass',        year:'2026', version:'Limited Premium',       img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F0d3d7a1dc7e07f0e64c4fb84601cc8fa871c5acc.jpg?generation=1777350234540448&alt=media',    deal:'Descuento promocional de $30,000 en pago de contado',       badge:'HOT',         link:'#', accent:'#424D07' },
    { id:3,  brand:'Jeep',    type:'SUV',        model:'Commander',      year:'2026', version:'Overland FWD',          img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F0c31e45701627ca72a88b646087445172fc4a302.jpg?generation=1777350234492066&alt=media',    deal:'Tasa desde 9.99% + Comisión por apertura gratis',          badge:null,             link:'#', accent:'#424D07' },
    { id:4,  brand:'Jeep',    type:'SUV',        model:'Renegade',       year:'2026', version:'Latitude',              img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F03eb70622ac5b618a05ca4b50608ada9e5f36dff.jpg?generation=1777350234483821&alt=media',    deal:'Desde $456,900 · Mensualidad desde $5,499',                 badge:null,             link:'#', accent:'#424D07' },
    { id:5,  brand:'Fiat',    type:'SUV',        model:'Pulse',          year:'2026', version:'Drive',                 img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F12af6dc13f44f29033d673c803a50f637af22da0.jpg?generation=1777350234700225&alt=media',    deal:'Bono de hasta $20,000 ó Tasa desde 7.99% + 0% de comisión por apertura', badge:'NUEVO',       link:'#', accent:'#D50000' },
    ...
    { id:7,  brand:'Fiat',    type:'SUV',        model:'Fastback',       year:'2026', version:'Limited',               img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F73305e43e64c51813013640443da7b7c6dbe392e.jpg?generation=1777350234711531&alt=media',    deal:'Desde $482,900 · Enganche $55,000 · Tasa 7.99%',           badge:null,             link:'#', accent:'#D50000' },
    ...
    { id:9,  brand:'Dodge',   type:'SUV',        model:'Durango',        year:'2026', version:'Hellcat SRT',           img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F1d6f3f42a55407817e0572a9323b9aa10c891633.jpg?generation=1777350234722595&alt=media',    deal:'Plan de financiamiento con Tasa desde 14.50%',             badge:'POTENCIA',    link:'#', accent:'#D50000' },
    { id:10, brand:'Dodge',   type:'Sedán',      model:'Attitude',       year:'2026', version:'SXT',                   img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2Ffd24ea9b590e1057b2b5aece02f0924645f557d3.jpg?generation=1777350234728971&alt=media',    deal:'Desde $379,900 · Mensualidad desde $4,299',                 badge:null,             link:'#', accent:'#D50000' },
    { id:11, brand:'Dodge',   type:'SUV',        model:'Journey',        year:'2026', version:'GT PLUS',               img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2Fc8f39b8a62ba049430811aa128ea21a793615787.jpg?generation=1777350234748118&alt=media',    deal:'Plan de financiamiento con Tasa desde 14.50% sin comisión', badge:null,             link:'#', accent:'#D50000' },
    { id:12, brand:'Peugeot', type:'SUV',        model:'Nueva 2008',     year:'2026', version:'GT',                    img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F7ac848efe89adde5660e4d2956b4983e1775ce00.jpg?generation=1777350234794617&alt=media',    deal:'Bono de $62,000 + Tasa de 9.99% sin comisión por apertura + 3 años de mantenimiento gratis', badge:'MEJOR PRECIO', link:'#', accent:'#0074E8' },
    { id:13, brand:'Peugeot', type:'SUV',        model:'Nueva 5008',     year:'2026', version:'GT',                    img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2Fa324072dc54a25de50940520db820b447f976fdd.jpg?generation=1777350234728825&alt=media',    deal:'Tasa desde 9.99% + 0% de comisión por apertura + 3 años de mantenimiento gratis', badge:null,             link:'#', accent:'#0074E8' },
    ...
    { id:15, brand:'Peugeot', type:'Van',        model:'Nueva Partner',  year:'2026', version:'Active',                img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2Fb1d61b52adc2aa72f9170a07361f38035b5794a8.jpg?generation=1777350234922828&alt=media',    deal:'Desde $439,900 · Tasa 11.99% · 2 años mantenimiento',       badge:null,             link:'#', accent:'#0074E8' },
    { id:16, brand:'Ram',     type:'Pick-ups',   model:'1500',           year:'2026', version:'Laramie',               img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2F366059fdfc8601cb267c2dfe66bce5eff26e9802.jpg?generation=1777350234982606&alt=media',    deal:'Plan de financiamiento con Tasa desde 14.50%',             badge:'TOP',          link:'#', accent:'#880D00' },
    { id:17, brand:'Ram',     type:'Pick-ups',   model:'1200',           year:'2026', version:'Limited',               img:'https://storage.googleapis.com/download/storage/v1/b/prd-storytodesign.appspot.com/o/h2d-ext-asset%2Fd77a3a9cf0b124b56b0ca97a272a05d66cdb4f9b.jpg?generation=1777350234972552&alt=media',    deal:'Desde $408,400 · Bono $47,000 · Tasa 14.50%',              badge:null,             link:'#', accent:'#880D00' },
  ...
  const SPECIAL_PROMOS = [
    ...
    { id:905, brand:'Ram',     hugeText:'14.5%',  hugeSub:'TASA PREFERENCIAL',      title:'RAM 1500 2026',    desc:'Plan de financiamiento con Tasa desde 14.50%.',                  img:'/adistem2026/ram-demo/ram-1500-cockpit.webp',   models:['RAM 1500 2026','RAM 1200 2026'],                            accent:'#880D00' },
  ]
